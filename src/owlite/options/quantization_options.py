...
class NodeQuantizationOptions(OptionsDict[str, FakeQuantizerOptions]):
    """
    * Key (str): the input node index or a predefined key. Numeric string keys are for inter-nodal modifications, 
    while alphabetic string keys are for intra-nodal modifications.
